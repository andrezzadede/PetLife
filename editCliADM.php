...
<html>
    ...
    <body >
        ...
        <form class="form-horizontal" method="POST" action="editADM.php">
        <div class="form-group">
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                ...
                onclick="delet(<?php echo $id?>)" class="btn btn-default">Deletar</a>
              </center>
              </div>
            </div>
          </form>
    ...
    function delet(id){
        if(confirm("Para desfazer do cliente, click em confirmar")){
            window.location.href="deleteCli.php?id="+id;
